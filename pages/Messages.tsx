...
import { MessageItemSkeleton } from '../components/common/LoadingStates';
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            CONVERSATIONS.map(conv => (
              <div key={conv.id} className="p-3 flex items-center space-x-3 hover:bg-gray-50 cursor-pointer rounded-lg mx-2 my-1 transition-colors animate-fade-in">
                <div className="relative">
